...
if (script === undefined) {
  ...
  script = document.querySelector('script[src^="https://theo.lol/client.js"],script[src^="http://localhost:4000/client.js"]') as HTMLScriptElement;
}
...
const utterancesOrigin = script.src.match(/^https:\/\/theo\.lol|http:\/\/localhost:\d+/)![0];
